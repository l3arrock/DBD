...
/**
 * This is the model class for table "knowledge_them".
 *
 * The followings are the available columns in table 'knowledge_them':
 * @property integer $id
 * @property integer $main_id
 * @property string $appro_status
 * @property string $date_appro
 *
 * The followings are the available model relations:
 * @property Knowledge $main
 */
class KnowledgeThemBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return KnowledgeThemBase the static model class
	 */
